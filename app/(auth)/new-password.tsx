...
export default function NewPassword() {
  ...
  return (
    <AuthCardWrapper
      headerTitle="Crea una nuova password"
      headerSubtitle="Inserisci la tua nuova password"
      ...
      <VStack space="xl" className="w-full">
          ...
          <Controller
            ...
            rules={{
              validate: async (value) => {
                try {
                  await NewPasswordSchema.parseAsync({ password: value });
                  return true;
                } catch (error: any) {
        ...
        >
          ...
          <Controller
            ...
            rules={{
              validate: async (value) => {
                try {
                  await NewPasswordSchema.parseAsync({ confirmPassword: value });
                  return true;
                } catch (error: any) {
                  return error.message;
                }
        ...
        <VStack className="w-full my-7 " space="lg">
          <Button className="w-full" onPress={handleSubmit(onSubmit)}>
            <ButtonText className="font-medium">Cambia Password</ButtonText>
          </Button>
        </VStack>
      </VStack>
    </AuthCardWrapper>
